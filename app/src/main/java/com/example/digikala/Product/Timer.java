...
public class Timer extends LinearLayout {
    ...
    public void inint(final Context context){
        ...
        View view =  layoutInflater.inflate(R.layout.product_timer,this,true);



        pic=view.findViewById(R.id.Lin_product_timer_img);
        title=view.findViewById(R.id.Lin_product_timer_title);
        non_price=view.findViewById(R.id.Lin_product_timer_pprice);
        linearLayout=view.findViewById(R.id.Lin_product_timer_LinearLayout);
